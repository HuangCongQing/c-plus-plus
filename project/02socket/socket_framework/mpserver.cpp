...
int main(int argc,char *argv[])
{
  ...
  // const char* argv_1 = 5005;
  // string argv_2 = '/tmp/mpserver_biz.log'; // c++11标准

  // 打开日志文件。
  // if (logfile.Open(argv[2],"a+")==false) { printf("logfile.Open(%s) failed.\n",argv[2]); return -1;}
  // if (logfile.Open(argv_2.c_str(),"a+")==false) { printf("logfile.Open(%s) failed.\n",argv_2.c_str()); return -1;}
  ...
  // }
  if (TcpServer.InitServer(5050)==false) // 初始化TcpServer的通信端口。
  {
